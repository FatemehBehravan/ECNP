def the_args():
    ...
    parser.add_argument('-x_size', '--x_size', type=int, default=4, help='x_size')
    ...
    parser.add_argument('-tr_it', '--training_iterations', type=int, default=5000, help='Number of training iterations')
